...
#build features
df_period1 = df.pct_change(periods=1)
df['ret1'] = df_period1['<CLOSE>'].fillna(0)
del df_period1
df_period2 = df.pct_change(periods=2)
df['ret2'] = df_period2['<CLOSE>'].fillna(0)
del df_period2
df_period5 = df.pct_change(periods=5)
df['ret5'] = df_period5['<CLOSE>'].fllna(0)
del df_period5
df_period20 = df.pct_change(periods=20)
df['ret20'] = df_period20['<CLOSE>'].fillna(0)
del df_period20
